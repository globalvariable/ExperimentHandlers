...
bool handle_mov_obj_dur_handler_to_mov_obj_handler_msg(MovObjData *mov_obj_data, MovObjStatus *mov_obj_status, TimeStamp current_time, MovObjDurHand2MovObjHandMsg *msgs_mov_obj_dur_hand_2_mov_obj_hand)
{
	MovObjDurHand2MovObjHandMsgItem *msg_item;
	char str_exp_envi_dur_msg[MOV_OBJ_DUR_HAND_2_MOV_OBJ_HAND_MSG_STRING_LENGTH];
	while (get_next_exp_envi_dur_hand_2_exp_envi_hand_msg_buffer_item(msgs_exp_envi_dur_hand_2_exp_envi_hand, &msg_item))
	{
		...
		print_message(INFO_MSG ,"MovObjHandler", "HandleMovObjDurHand2MovObjHandMsgs", "handle_exp_envi_dur_handler_to_exp_envi_handler_msg", str_exp_envi_dur_msg);
		switch (msg_item->msg_type)
		{
			case MOV_OBJ_DUR_HAND_2_MOV_OBJ_HAND_MSG_TIMEOUT:	
				...
				break;
			default:
				return print_message(BUG_MSG ,"MovObjHandler", "HandleMovObjDurHand2MovObjHandMsgs", "handle_exp_envi_dur_handler_to_exp_envi_handler_msg", str_exp_envi_dur_msg);
		}
	}
