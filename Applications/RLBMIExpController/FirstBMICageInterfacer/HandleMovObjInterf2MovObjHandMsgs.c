...
bool handle_mov_obj_interf_2_mov_obj_hand_msgs(char *rx_buff, MovObjInterf2MovObjHandMsg *msgs_mov_obj_interf_2_mov_obj_hand, TimeStamp current_time)
{
	...
	{
		if (! write_to_mov_obj_interf_2_mov_obj_hand_msg_buffer(msgs_mov_obj_interf_2_mov_obj_hand, current_time, MOV_OBJ_INTERF_2_MOV_OBJ_HAND_MSG_DIRECTION_SPEED_LOCATION, ONE_D_ACTUATOR, MOV_OBJ_DIRECTION_NULL, MOV_OBJ_SPEED_NULL, (mov_obj_rs232_rx.location.location*(0.08/272.0))))   // send location in means of meters.
