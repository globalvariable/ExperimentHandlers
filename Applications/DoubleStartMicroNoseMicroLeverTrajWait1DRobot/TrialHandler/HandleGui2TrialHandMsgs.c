	...
	while (get_next_gui_2_trial_hand_msg_buffer_item(msgs_gui_2_trial_hand, &msg_item))
	{
		...
		switch (msg_item.msg_type)
		{
			...
			case GUI_2_TRIAL_HAND_MSG_CATCH_TRIAL_MODE_ON:
				...
				break;
			case GUI_2_TRIAL_HAND_MSG_FULL_CATCH_TRIAL_MODE_OFF:
				switch (*trial_status)
				{
					case TRIAL_STATUS_TRIALS_DISABLED:
						paradigm->current_trial_data.full_catch_trial_mode_on = FALSE;
						break;
					case TRIAL_STATUS_IN_TRIAL:
						paradigm->current_trial_data.full_catch_trial_mode_on = FALSE;
						break;
			...
			case GUI_2_TRIAL_HAND_MSG_FULL_CATCH_TRIAL_MODE_ON:
				...
				{
					case TRIAL_STATUS_TRIALS_DISABLED:
						paradigm->current_trial_data.full_catch_trial_mode_on = TRUE;
						break;
					case TRIAL_STATUS_IN_TRIAL:
						paradigm->current_trial_data.full_catch_trial_mode_on = TRUE;
						break;
