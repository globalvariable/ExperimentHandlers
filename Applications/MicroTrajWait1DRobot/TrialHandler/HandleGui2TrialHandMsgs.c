	...
	while (get_next_gui_2_trial_hand_msg_buffer_item(msgs_gui_2_trial_hand, &msg_item))
	{
		...
		switch (msg_item.msg_type)
		{
			...
			case GUI_2_TRIAL_HAND_MSG_TURN_NOSE_RETRACT_MODE_ON:
				...
				{
					case TRIAL_STATUS_TRIALS_DISABLED:
						paradigm->current_trial_data.nose_retract_mode_on = TRUE;
						break;
					case TRIAL_STATUS_IN_TRIAL:
						print_message(ERROR_MSG ,"TrialHandler", "HandleGui2TrialHandMsgs", "handle_gui_to_trial_handler_msg", "TURN_NOSE_RETRACT_MODE_ON cannot be done during TRIAL_STATUS_IN_TRIAL");
						break;
					case TRIAL_STATUS_IN_REFRACTORY:
						paradigm->current_trial_data.nose_retract_mode_on = TRUE;
						break;
					...
					case TRIAL_STATUS_WAIT_FOR_NOSE_RETRACT:
						print_message(ERROR_MSG ,"TrialHandler", "HandleGui2TrialHandMsgs", "handle_gui_to_trial_handler_msg", "TURN_NOSE_RETRACT_MODE_ON cannot be done during TRIAL_STATUS_WAIT_FOR_NOSE_RETRACT");
						break;
					default:
						print_message(BUG_MSG ,"TrialHandler", "HandleGui2TrialHandMsgs", "handle_gui_to_trial_handler_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
			...
			case GUI_2_TRIAL_HAND_MSG_TURN_NOSE_RETRACT_MODE_OFF:
				switch (*trial_status)
				{
					case TRIAL_STATUS_TRIALS_DISABLED:
						...
						break;
					case TRIAL_STATUS_IN_TRIAL:
						print_message(ERROR_MSG ,"TrialHandler", "HandleGui2TrialHandMsgs", "handle_gui_to_trial_handler_msg", "TURN_NOSE_RETRACT_MODE_OFF cannot be done during TRIAL_STATUS_IN_TRIAL");
						break;
					case TRIAL_STATUS_IN_REFRACTORY:
						paradigm->current_trial_data.nose_retract_mode_on = FALSE;
						break;
					case TRIAL_STATUS_START_TRIAL_AVAILABLE:	
						...
						break;
					case TRIAL_STATUS_WAIT_FOR_NOSE_RETRACT:
						print_message(ERROR_MSG ,"TrialHandler", "HandleGui2TrialHandMsgs", "handle_gui_to_trial_handler_msg", "TURN_NOSE_RETRACT_MODE_OFF cannot be done during TRIAL_STATUS_WAIT_FOR_NOSE_RETRACT");
						break;
					default:
						print_message(BUG_MSG ,"TrialHandler", "HandleGui2TrialHandMsgs", "handle_gui_to_trial_handler_msg", str_gui_msg);
						get_trial_status_type_string(*trial_status, str_status);   
