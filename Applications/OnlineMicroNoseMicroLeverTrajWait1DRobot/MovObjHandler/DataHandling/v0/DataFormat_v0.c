...
static int create_main_meta_file(char *main_directory_path, MovObjHandParadigmRobotReach *paradigm, ThreeDofRobot *robot_arm)
{
	...
	fprintf(fp,"MovObjHandParadigmRobotReach.stay_at_start_duration\t%llu\n", paradigm->stay_at_start_duration);
	...
	fprintf(fp,"MovObjHandParadigmRobotReach.threshold.target_reach_threshold.r_x\t%.15f\n", paradigm->threshold.target_reach_threshold.r_x);
	fprintf(fp,"MovObjHandParadigmRobotReach.threshold.target_reach_threshold.r_y\t%.15f\n", paradigm->threshold.target_reach_threshold.r_y);
	fprintf(fp,"MovObjHandParadigmRobotReach.threshold.target_reach_threshold.r_z\t%.15f\n", paradigm->threshold.target_reach_threshold.r_z);
