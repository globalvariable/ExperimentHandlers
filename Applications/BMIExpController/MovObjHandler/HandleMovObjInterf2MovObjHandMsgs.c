...
bool handle_mov_obj_interf_to_mov_obj_handler_msg(MovObjData *mov_obj_data, MovObjStatus *mov_obj_status, TrialType mov_obj_trial_type_status, TimeStamp current_time, MovObjInterf2MovObjHandMsg *msgs_mov_obj_interf_2_mov_obj_hand, MovObjHand2MovObjDurHandMsg *msgs_mov_obj_hand_2_mov_obj_dur_hand)
{
	...
	while (get_next_mov_obj_interf_2_mov_obj_hand_msg_buffer_item(msgs_mov_obj_interf_2_mov_obj_hand, &msg_item))
	{
		...
		print_message(INFO_MSG ,"MovObjHandler", "HandleMovObjInterf2MovObjHandMsgs", "handle_mov_obj_interfler_to_mov_obj_handler_msg", str_mov_obj_interf_msg);
			...
			case MOV_OBJ_INTERF_2_MOV_OBJ_HAND_MSG_DIRECTION_SPEED_LOCATION:	
				switch (*mov_obj_status)
				{
					case MOV_OBJ_STATUS_OUT_OF_TRIAL:
						print_message(BUG_MSG ,"MovObjHandler", "HandleMovObjInterf2MovObjHandMsgs", "handle_mov_obj_interfler_to_mov_obj_handler_msg", str_mov_obj_interf_msg);	
					...
					case MOV_OBJ_STATUS_AVAILABLE_TO_CONTROL:
						switch (mov_obj_trial_type_status)
						{
							...
							default:
								print_message(BUG_MSG ,"MovObjHandler", "HandleMovObjInterf2MovObjHandMsgs", "handle_mov_obj_interfler_to_mov_obj_handler_msg", str_mov_obj_interf_msg);	
								get_mov_obj_status_type_string(*mov_obj_status, str_mov_obj_status);   
								print_message(BUG_MSG ,"MovObjHandler", "HandleMovObjInterf2MovObjHandMsgs", "handle_mov_obj_interfler_to_mov_obj_handler_msg", str_mov_obj_status);	
								return print_message(BUG_MSG ,"MovObjHandler", "HandleMovObjInterf2MovObjHandMsgs", "handle_mov_obj_interfler_to_mov_obj_handler_msg", "switch (mov_obj_trial_type_status)");	
						}
						break;
				...
				break;
			default:
				return print_message(BUG_MSG ,"MovObjHandler", "HandleMovObjInterf2MovObjHandMsgs", "handle_mov_obj_interfler_to_mov_obj_handler_msg", str_mov_obj_interf_msg);
		}
	}
