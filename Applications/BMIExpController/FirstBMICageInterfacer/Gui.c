...
void create_gui_handler(Gui2ExpEnviInterfMsg *msgs_gui_2_exp_envi_interf, Gui2MovObjInterfMsg *msgs_gui_2_mov_obj_interf)
{
	GtkWidget *window, *vbox, *tabs;
 	...
 	window = gtk_window_new(GTK_WINDOW_TOPLEVEL);
  	...
  	gtk_window_set_title(GTK_WINDOW(window), "BMIExpController - First BMI Cage Interfacer");
	...
	if (!create_cage_interfacer_tab(tabs, msgs_gui_2_exp_envi_interf, msgs_gui_2_mov_obj_interf))
