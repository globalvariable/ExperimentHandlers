			...
			case TRIAL_HAND_2_MOV_OBJ_HAND_MSG_START_TRIAL:	
				switch (*mov_obj_status)
				{
					case MOV_OBJ_STATUS_OUT_OF_TRIAL:
						mov_obj_paradigm->start_position_pulse[0] = msg_item.additional_data.three_dof_robot_additional.start_position_pulse[0];
						mov_obj_paradigm->start_position_pulse[1] = msg_item.additional_data.three_dof_robot_additional.start_position_pulse[1];
						mov_obj_paradigm->start_position_pulse[2] = msg_item.additional_data.three_dof_robot_additional.start_position_pulse[2];
						mov_obj_paradigm->target_position_pulse[0] = msg_item.additional_data.three_dof_robot_additional.target_position_pulse[0];
						mov_obj_paradigm->target_position_pulse[1] = msg_item.additional_data.three_dof_robot_additional.target_position_pulse[1];
						mov_obj_paradigm->target_position_pulse[2] = msg_item.additional_data.three_dof_robot_additional.target_position_pulse[2];
