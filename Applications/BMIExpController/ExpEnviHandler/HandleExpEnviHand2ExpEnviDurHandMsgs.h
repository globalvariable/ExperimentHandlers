...
bool handle_exp_envi_handler_to_exp_envi_dur_handler_msg(ExpEnviDurationStatus *exp_envi_dur_status, TimeStamp current_time, ExpEnviHand2ExpEnviDurHandMsg *msgs_exp_envi_hand_2_exp_envi_dur_hand);
