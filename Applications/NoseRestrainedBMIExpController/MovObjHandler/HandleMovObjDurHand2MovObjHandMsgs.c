			...
			case MOV_OBJ_DUR_HAND_2_MOV_OBJ_HAND_MSG_TIMEOUT:
				switch (msg_item.additional_data)
				{
					...
					case MOV_OBJ_DUR_STATUS_ITEM_SEND_PULSE_WIDTH:
						if (! handle_exp_envi_tx_shm_and_send_rs232_pulse_width_command(current_time, robot_pulse_history, mov_obj_paradigm->max_servo_angle_change, mov_obj_paradigm->spike_2_servo_degree_handling_period_multiplier, mov_obj_paradigm->servo_angle_change_threshold ))
