...
static bool connect_to_exp_envi_hand(void)
{
	...
	sleep(1);	
	if (!write_to_trial_hand_2_exp_envi_hand_msg_buffer(msgs_trial_hand_2_exp_envi_hand, *sys_time_ptr, TRIAL_HAND_2_EXP_ENVI_HAND_MSG_ARE_YOU_ALIVE, 0))
...
static bool connect_to_mov_obj_hand(void)
{
	...
	if (!write_to_trial_hand_2_mov_obj_hand_msg_buffer(msgs_trial_hand_2_mov_obj_hand, *sys_time_ptr, TRIAL_HAND_2_MOV_OBJ_HAND_MSG_ARE_YOU_ALIVE, trial_hand_2_mov_obj_hand_add))
...
static bool connect_to_neural_net(void)
{
	...
	if (!write_to_trial_hand_2_neural_net_msg_buffer(msgs_trial_hand_2_neural_net, *sys_time_ptr, TRIAL_HAND_2_NEURAL_NET_MSG_ARE_YOU_ALIVE, trial_hand_to_neural_net_msg_add))
		...
		while (get_next_neural_net_2_trial_hand_msg_buffer_item(msgs_neural_net_2_trial_hand, &msg_item))
		{
			...
			switch (msg_item.msg_type)
			{
				case NEURAL_NET_2_TRIAL_HAND_MSG_I_AM_ALIVE:
					...
					trial_hand_to_neural_net_msg_add.dummy = 0;
					if (!write_to_trial_hand_2_neural_net_msg_buffer(msgs_trial_hand_2_neural_net, *sys_time_ptr, TRIAL_HAND_2_SPIKE_GEN_MSG_TRIAL_STATUS_CHANGED, trial_hand_to_neural_net_msg_add))
						return print_message(ERROR_MSG ,"TrialHandler", "TrialHandlerRtTask", "connect_to_neural_net", "write_to_trial_hand_2_neural_net_msg_buffer().");	
					return TRUE;			
				default:
...
static bool connect_to_spike_gen(void)
{
	...
	if (!write_to_trial_hand_2_spike_gen_msg_buffer(msgs_trial_hand_2_spike_gen, *sys_time_ptr, TRIAL_HAND_2_SPIKE_GEN_MSG_ARE_YOU_ALIVE, trial_hand_to_spike_gen_msg_add))
		...
		while (get_next_spike_gen_2_trial_hand_msg_buffer_item(msgs_spike_gen_2_trial_hand, &msg_item))
		{
			...
			switch (msg_item.msg_type)
			{
				case SPIKE_GEN_2_TRIAL_HAND_MSG_I_AM_ALIVE:
					...
					trial_hand_to_spike_gen_msg_add.dummy = 0;
					if (!write_to_trial_hand_2_spike_gen_msg_buffer(msgs_trial_hand_2_spike_gen, *sys_time_ptr, TRIAL_HAND_2_SPIKE_GEN_MSG_TRIAL_STATUS_CHANGED, trial_hand_to_spike_gen_msg_add))
						return print_message(ERROR_MSG ,"TrialHandler", "TrialHandlerRtTask", "connect_to_spike_gen", "write_to_trial_hand_2_spike_gen_msg_buffer().");
					return TRUE;			
				default:
...
static bool connect_to_neu_rec_hand(void)
{
	...
	sleep(1);	
	if (!write_to_trial_hand_2_neu_rec_hand_msg_buffer(msgs_trial_hand_2_neu_rec_hand, *sys_time_ptr, TRIAL_HAND_2_NEU_REC_HAND_MSG_ARE_YOU_ALIVE, 0))
