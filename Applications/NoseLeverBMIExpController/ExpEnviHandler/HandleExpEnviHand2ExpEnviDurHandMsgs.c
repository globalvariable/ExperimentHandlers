			...
			case EXP_ENVI_HAND_2_EXP_ENVI_DUR_HAND_MSG_START_INPUT_MIN_TIMER:	
				switch (msg_item.comp_num)
				{
					...
					case LEFT_LEVER_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_min_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA])
						{
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON:
								...
								get_exp_envi_dur_status_type_string(exp_envi_inputs_min_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA] = msg_item.additional_data;
								exp_envi_inputs_min_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_dur_status_type_string(exp_envi_inputs_min_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
					...
					case RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_min_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA])
						{
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA");
								get_exp_envi_dur_status_type_string(exp_envi_inputs_min_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA] = msg_item.additional_data;
								exp_envi_inputs_min_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_dur_status_type_string(exp_envi_inputs_min_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
						 ...
						 break;			
					case NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_min_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA])
						{
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA");
								get_exp_envi_dur_status_type_string(exp_envi_inputs_min_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA] = msg_item.additional_data;
								exp_envi_inputs_min_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_dur_status_type_string(exp_envi_inputs_min_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status); 
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
			...
			case EXP_ENVI_HAND_2_EXP_ENVI_DUR_HAND_MSG_CANCEL_INPUT_MIN_TIMER:	
				switch (msg_item.comp_num)
				{
					...
					case LEFT_LEVER_IDX_IN_EXP_ENVI_DATA:
						...
						{
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_min_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA:
						...
						{
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_min_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA:
						...
						{
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_min_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_MIN_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
				...
				switch (msg_item.comp_num)
				{
					case IR_BEAM_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_max_dur_status[IR_BEAM_IDX_IN_EXP_ENVI_DATA])
						{
						 ...
						 break;			
					case LEFT_LEVER_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_max_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA])
						{
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "LEFT_LEVER_IDX_IN_EXP_ENVI_DATA");
								...
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_max[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA] = msg_item.additional_data;
								exp_envi_inputs_max_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_dur_status_type_string(exp_envi_inputs_max_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
						 ...
						 break;	
					case RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_max_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA])
						{
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA");
								get_exp_envi_dur_status_type_string(exp_envi_inputs_max_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_max[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA] = msg_item.additional_data;
								exp_envi_inputs_max_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_dur_status_type_string(exp_envi_inputs_max_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);  
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
						 ...
						 break;	
					case NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA:
						switch (exp_envi_inputs_max_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA])
						{
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA");
								get_exp_envi_dur_status_type_string(exp_envi_inputs_max_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_max[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA] = msg_item.additional_data;
								exp_envi_inputs_max_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_dur_status_type_string(exp_envi_inputs_max_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA], str_exp_envi_dur_status); 
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_dur_status);
			...
			case EXP_ENVI_HAND_2_EXP_ENVI_DUR_HAND_MSG_CANCEL_INPUT_MAX_TIMER:	
				switch (msg_item.comp_num)
				{
					...
					case LEFT_LEVER_IDX_IN_EXP_ENVI_DATA:
						...
						{
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_max_dur_status[LEFT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA:
						...
						{
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_max_dur_status[RIGHT_LEVER_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA:
						...
						{
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_max_dur_status[NOSE_RETRACT_IR_IDX_IN_EXP_ENVI_DATA] = EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_MAX_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
