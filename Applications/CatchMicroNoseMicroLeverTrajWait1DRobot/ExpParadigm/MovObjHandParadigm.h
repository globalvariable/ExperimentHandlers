...
#define MOV_OBJ_RESET_SPEED_RATIO 	0.07
...
typedef struct 
{
	EllipsoidThreshold			start_reach_threshold;
	EllipsoidThreshold			target_reach_threshold;
	EllipsoidThreshold			lever_press_reach_threshold;
	EllipsoidThreshold			lever_press_reach_threshold_escape;
}
MovObjThreshold;
...
typedef struct 
{
	...
	bool						random_traj_mode;
	double						randomization_level;
