...
static void *rt_exp_envi_duration_handler(void *args)
{
	...
	if (! check_rt_task_specs_to_init(static_rt_tasks_data, EXP_ENVI_DURATION_HANDLER_CPU_ID, EXP_ENVI_DURATION_HANDLER_CPU_THREAD_ID, EXP_ENVI_DURATION_HANDLER_PERIOD))  {
	...
	if (! write_rt_task_specs_to_rt_tasks_data(static_rt_tasks_data, EXP_ENVI_DURATION_HANDLER_CPU_ID, EXP_ENVI_DURATION_HANDLER_CPU_THREAD_ID, EXP_ENVI_DURATION_HANDLER_PERIOD, EXP_ENVI_DURATION_HANDLER_POSITIVE_JITTER_THRES, EXP_ENVI_DURATION_HANDLER_NEGATIVE_JITTER_THRES))  {
        ...
        while (rt_exp_envi_duration_handler_stay_alive) 
	{
		...
		evaluate_and_save_jitter(static_rt_tasks_data, EXP_ENVI_DURATION_HANDLER_CPU_ID, EXP_ENVI_DURATION_HANDLER_CPU_THREAD_ID, prev_time, curr_time);
		prev_time = curr_time;
		...
		// routines	
		evaluate_and_save_period_run_time(static_rt_tasks_data, EXP_ENVI_DURATION_HANDLER_CPU_ID, EXP_ENVI_DURATION_HANDLER_CPU_THREAD_ID, curr_time, rt_get_cpu_time_ns());		
        }
