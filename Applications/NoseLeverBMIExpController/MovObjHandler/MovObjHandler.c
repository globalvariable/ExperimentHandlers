...
int main( int argc, char *argv[])
{
	...
	mov_obj_paradigm->stay_at_start_duration = 300000000;   

	mov_obj_paradigm->spike_2_servo_degree_multiplier = 0.4;
	mov_obj_paradigm->spike_2_servo_degree_handling_period_multiplier = 4;  /// to be 100 ms
	mov_obj_paradigm->max_servo_angle_change = 4;
	mov_obj_paradigm->servo_angle_change_threshold = 3.2;
