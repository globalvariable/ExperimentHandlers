...
*/
	...
	mov_obj_paradigm->threshold.lever_press_reach_threshold.r_x = 4.0;  // 4.0 - 4.5 is good for well-learned rat.	// for correct targets, rat should wait until this threshold. it is the DISTANCE FROM TARGET
	mov_obj_paradigm->threshold.lever_press_reach_threshold.r_y = 4.0;
	mov_obj_paradigm->threshold.lever_press_reach_threshold.r_z = 4.0;


	mov_obj_paradigm->threshold.lever_press_reach_threshold_escape.r_x = 3.0;  
	mov_obj_paradigm->threshold.lever_press_reach_threshold_escape.r_y = 3.0;
	mov_obj_paradigm->threshold.lever_press_reach_threshold_escape.r_z = 3.0;

	mov_obj_paradigm->threshold.start_reach_threshold.r_x = 1.0;
	mov_obj_paradigm->threshold.start_reach_threshold.r_y = 5.0;
	mov_obj_paradigm->threshold.start_reach_threshold.r_z = 1.0;
