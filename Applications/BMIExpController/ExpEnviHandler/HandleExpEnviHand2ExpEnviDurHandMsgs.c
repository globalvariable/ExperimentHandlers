...
BURADA MAX MIN TIMER START STOP ETC
					...
					case IR_BEAM:
						switch (exp_envi_inputs_min_dur_status[IR_BEAM])
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								...
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_min_dur_status[IR_BEAM], str_exp_envi_inp_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[IR_BEAM] = msg_item->additional_data_0;
								inputs_handling_end_time_max[IR_BEAM] = msg_item->additional_data_1;
								exp_envi_inputs_min_dur_status[IR_BEAM] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_min_dur_status[IR_BEAM], str_exp_envi_inp_dur_status); 
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
					...
					case LEFT_LEVER:
						switch (exp_envi_inputs_min_dur_status[LEFT_LEVER])
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								...
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_min_dur_status[LEFT_LEVER], str_exp_envi_inp_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[LEFT_LEVER] = msg_item->additional_data_0;
								inputs_handling_end_time_max[LEFT_LEVER] = msg_item->additional_data_1;
								exp_envi_inputs_min_dur_status[LEFT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_min_dur_status[LEFT_LEVER], str_exp_envi_inp_dur_status);
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
					...
					case RIGHT_LEVER:
						switch (exp_envi_inputs_min_dur_status[RIGHT_LEVER])
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								...
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_min_dur_status[RIGHT_LEVER], str_exp_envi_inp_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[RIGHT_LEVER] = msg_item->additional_data_0;
								inputs_handling_end_time_max[RIGHT_LEVER] = msg_item->additional_data_1;
								exp_envi_inputs_min_dur_status[RIGHT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_min_dur_status[RIGHT_LEVER], str_exp_envi_inp_dur_status);  
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
			...
			case EXP_ENVI_HAND_2_EXP_ENVI_DUR_HAND_MSG_CANCEL_MIN_TIMER:	
				switch (msg_item->inp_comp_num)
				{
					case IR_BEAM:
						...
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_min_dur_status[IR_BEAM] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case LEFT_LEVER:
						...
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_min_dur_status[LEFT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case RIGHT_LEVER:
						...
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_min_dur_status[RIGHT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
				...
				switch (msg_item->inp_comp_num)
				{
					case IR_BEAM:
						switch (exp_envi_inputs_max_dur_status[IR_BEAM])
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "IR_BEAM");
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_max_dur_status[IR_BEAM], str_exp_envi_inp_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[IR_BEAM] = msg_item->additional_data_0;
								inputs_handling_end_time_max[IR_BEAM] = msg_item->additional_data_1;
								exp_envi_inputs_max_dur_status[IR_BEAM] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_max_dur_status[IR_BEAM], str_exp_envi_inp_dur_status); 
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
					...
					case LEFT_LEVER:
						switch (exp_envi_inputs_max_dur_status[LEFT_LEVER])
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "LEFT_LEVER");
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_max_dur_status[LEFT_LEVER], str_exp_envi_inp_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[LEFT_LEVER] = msg_item->additional_data_0;
								inputs_handling_end_time_max[LEFT_LEVER] = msg_item->additional_data_1;
								exp_envi_inputs_max_dur_status[LEFT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_max_dur_status[LEFT_LEVER], str_exp_envi_inp_dur_status);
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
					...
					case RIGHT_LEVER:
						switch (exp_envi_inputs_max_dur_status[RIGHT_LEVER])
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", "RIGHT_LEVER");
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_max_dur_status[RIGHT_LEVER], str_exp_envi_inp_dur_status);   
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								inputs_handling_end_time_min[RIGHT_LEVER] = msg_item->additional_data_0;
								inputs_handling_end_time_max[RIGHT_LEVER] = msg_item->additional_data_1;
								exp_envi_inputs_max_dur_status[RIGHT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON;
								break;			
							default:
								get_exp_envi_input_dur_status_type_string(exp_envi_inputs_max_dur_status[RIGHT_LEVER], str_exp_envi_inp_dur_status);  
								return print_message(BUG_MSG ,"ExpEnviHandler", "HandleExpEnviHand2ExpEnviDurHandMsgs", "handle_exp_envi_handler_to_exp_envi_dur_handler_msg", str_exp_envi_inp_dur_status);
			...
			case EXP_ENVI_HAND_2_EXP_ENVI_DUR_HAND_MSG_CANCEL_MAX_TIMER:	
				switch (msg_item->inp_comp_num)
				{
					case IR_BEAM:
						...
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_max_dur_status[IR_BEAM] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case LEFT_LEVER:
						...
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_max_dur_status[LEFT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
					...
					case RIGHT_LEVER:
						...
						{
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_ON:
								exp_envi_inputs_max_dur_status[RIGHT_LEVER] = EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF;
								break;			
							case EXP_ENVI_INPUTS_DUR_STATUS_TIMER_OFF:
								break; // do nothing
							default:
