...
int main( int argc, char *argv[])
{
	...
	init_servo_angles_for_sample_averaging(&(robot_arm->servos[BASE_SERVO]), ((BASE_SERVO_INIT_PULSE-BASE_SERVO_0_DEGREE_PULSE)/(BASE_SERVO_90_DEGREE_PULSE-BASE_SERVO_0_DEGREE_PULSE))*M_PI_2, 2);  // it is required for check_three_dof_robot_security_limits(). Too weird initialization cannot pass check security limits.
	init_servo_angles_for_sample_averaging(&(robot_arm->servos[SHOULDER_SERVO]), ((SHOULDER_SERVO_INIT_PULSE-SHOULDER_SERVO_0_DEGREE_PULSE)/(SHOULDER_SERVO_90_DEGREE_PULSE-SHOULDER_SERVO_0_DEGREE_PULSE))*M_PI_2, 2);
	init_servo_angles_for_sample_averaging(&(robot_arm->servos[ELBOW_SERVO]), ((ELBOW_SERVO_INIT_PULSE-ELBOW_SERVO_0_DEGREE_PULSE)/(ELBOW_SERVO_90_DEGREE_PULSE-ELBOW_SERVO_0_DEGREE_PULSE))*M_PI_2, 2);  // it is required for check_three_dof_robot_security_limits(). Too weird initialization cannot pass check security limits.
	...
	mov_obj_paradigm->servo_pw_change_rate_for_position_reset_min = 0.015;
	mov_obj_paradigm->servo_pw_change_rate_for_position_reset_max = 0.030;
...
*/
	...
	mov_obj_paradigm->threshold.reward_available_threshold.r_x = 2;
	mov_obj_paradigm->threshold.reward_available_threshold.r_y = 2;
	mov_obj_paradigm->threshold.reward_available_threshold.r_z = 2;

	mov_obj_paradigm->threshold.lever_press_reach_threshold.r_x = 4;
	mov_obj_paradigm->threshold.lever_press_reach_threshold.r_y = 4;
	mov_obj_paradigm->threshold.lever_press_reach_threshold.r_z = 4;
